...
> = {
  ...
  // Booking conversion is QUALIFIED → BOOKED only (Phase 4 / Prompt 2 removed ENGAGED → BOOKED).
  ENGAGED: [S.QUALIFIED, S.OPTED_OUT, S.DORMANT_ARCHIVED],
  QUALIFIED: [S.BOOKED, S.OPTED_OUT, S.DORMANT_ARCHIVED],
  // BOOKED → QUALIFIED: the verified appointment was cancelled (Phase 3).
  BOOKED: [S.OPTED_OUT, S.QUALIFIED],
  OPTED_OUT: [],
  DORMANT_ARCHIVED: [],
};
